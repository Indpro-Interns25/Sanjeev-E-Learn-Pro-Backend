...
const lessonProgressRoutes = require('./lessonProgressRoutes');
...
router.use('/test', finalTestRoutes);
router.use('/videos', videoRoutes);
// Video progress endpoints accessible at both /videos/progress and /video-progress
router.post('/video-progress', validateToken, require('../controllers/videoController').saveVideoProgress);
router.get('/video-progress/:lectureId/:userId', validateToken, require('../controllers/videoController').getVideoProgress);
